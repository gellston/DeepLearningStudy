...
BiSegNet = BiSegNetMobileV3(class_num=classNum,
...
torch.jit.save(compiled_model, "C://Github//DeepLearningStudy//trained_model//BiSegNet(ReagentV3)_no_train.pt")
print('====================')
...
for epoch in range(training_epochs):
    ...
    BiSegNet.eval()
    compiled_model = torch.jit.script(BiSegNet)
    torch.jit.save(compiled_model, "C://Github//DeepLearningStudy//trained_model//BiSegNet(ReagentV3)_step.pt")
    ...
    if top_accuracy <= average_accuracy:
        ...
        BiSegNet.eval()
        compiled_model = torch.jit.script(BiSegNet)
        torch.jit.save(compiled_model, "C://Github//DeepLearningStudy//trained_model//BiSegNet(ReagentV3)_top.pt")

    if average_accuracy >= target_accuracy:
        BiSegNet.eval()
        compiled_model = torch.jit.script(BiSegNet)
        torch.jit.save(compiled_model, "C://Github//DeepLearningStudy//trained_model//BiSegNet(ReagentV3)_final.pt")
        break
