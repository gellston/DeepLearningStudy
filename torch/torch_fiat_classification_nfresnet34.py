...
from model.NFResNet import NFResNet34
...
torch.jit.save(compiled_model, "C://Github//DeepLearningStudy//trained_model//FIAT(NFResNet34).pt")
## no Train Model Save
