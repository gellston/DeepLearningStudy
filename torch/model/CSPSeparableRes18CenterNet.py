...
class CSPSeparableRes18CenterNet(torch.nn.Module):

    def __init__(self, class_num=5, activation=torch.nn.SiLU):
        super(CSPSeparableRes18CenterNet, self).__init__()
        ...
        self.conv2 = torch.nn.Sequential(CSPSeparableResidualBlock(in_dim=64, mid_dim=64, out_dim=64, stride=1,
                                                                   activation=activation),
                                         CSPSeparableResidualBlock(in_dim=64, mid_dim=64, out_dim=128, stride=2,
                                                                   activation=activation))

        self.conv3 = torch.nn.Sequential(CSPSeparableResidualBlock(in_dim=128, mid_dim=128, out_dim=128, stride=1,
                                                                   activation=activation),
                                         CSPSeparableResidualBlock(in_dim=128, mid_dim=128, out_dim=256, stride=2,
                                                                   activation=activation))

        self.conv4 = torch.nn.Sequential(CSPSeparableResidualBlock(in_dim=256, mid_dim=256, out_dim=256, stride=1,
                                                                   activation=activation),
                                         CSPSeparableResidualBlock(in_dim=256, mid_dim=256, out_dim=512, stride=2,
                                                                   activation=activation))

        self.conv5 = torch.nn.Sequential(CSPSeparableResidualBlock(in_dim=512, mid_dim=512, out_dim=512, stride=1,
                                                                   activation=activation),
                                         CSPSeparableResidualBlock(in_dim=512, mid_dim=512, out_dim=512, stride=2,
                                                                   activation=activation))
        ...
        self.feature_final_conv1 = torch.nn.Sequential(SeparableConv2d(in_channels=128,
                                                                       out_channels=128,
                                                                       kernel_size=3,
                                                                       bias=False,
                                                                       padding='same'),
        ...
        self.feature_final_conv2 = torch.nn.Sequential(SeparableConv2d(in_channels=128,
                                                                       out_channels=128,
                                                                       kernel_size=3,
                                                                       bias=False,
                                                                       padding='same'),
        ...
        self.feature_final_conv3 = torch.nn.Sequential(SeparableConv2d(in_channels=128,
                                                                       out_channels=128,
                                                                       kernel_size=3,
                                                                       bias=False,
                                                                       padding='same'),
        ...
        ##PredictionMap
        self.class_heatmap = torch.nn.Sequential(SeparableConv2d(in_channels=128,
                                                                 out_channels=64,
                                                                 kernel_size=3,
                                                                 bias=False,
                                                                 padding='same'),
        ...
        self.size_map = torch.nn.Sequential(SeparableConv2d(in_channels=128,
                                                            out_channels=64,
                                                            kernel_size=3,
                                                            bias=False,
                                                            padding='same'),
        ...
        self.offset_map = torch.nn.Sequential(SeparableConv2d(in_channels=128,
                                                              out_channels=64,
                                                              kernel_size=3,
                                                              bias=False,
                                                              padding='same'),
    ...
    def forward(self, x):
        ...
        up_sample1 = self.up_sample1(feature1) + feature2          #32x32x128
        final_feature1 = self.feature_final_conv1(up_sample1)
        up_sample2 = self.up_sample2(final_feature1) + feature3          #64x64x128
        final_feature2 = self.feature_final_conv2(up_sample2)
        up_sample3 = self.up_sample3(final_feature2) + feature4          #128x128x128
