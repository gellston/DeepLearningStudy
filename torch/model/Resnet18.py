...
class Resnet18(torch.nn.Module):
    ...
    def __init__(self, class_num=5, activation=torch.nn.SiLU):
        ...
        self.conv2 = torch.nn.Sequential(ResidualBlock(in_dim=64, mid_dim=64, out_dim=64, stride=2, activation=activation),
        ...
        self.conv5 = torch.nn.Sequential(ResidualBlock(in_dim=256, mid_dim=512, out_dim=512, stride=1, activation=activation),
