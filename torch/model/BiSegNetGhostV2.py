...
class BiSegNetGhostV2(torch.nn.Module):

    def __init__(self, class_num=5, activation=torch.nn.ReLU, use_activation=True):
        super(BiSegNetGhostV2, self).__init__()
        ...
        self.layer1 = torch.nn.Sequential(
            InvertedGhostBottleNeck(in_channels=16, out_channels=16, expansion_rate=6, stride=1, activation=activation),
            InvertedGhostBottleNeck(in_channels=16, out_channels=24, expansion_rate=6, stride=2, activation=activation)
        ) #4

        self.layer2 = torch.nn.Sequential(
            InvertedGhostBottleNeck(in_channels=24, out_channels=24, expansion_rate=6, stride=1, activation=activation),
            InvertedGhostBottleNeck(in_channels=24, out_channels=32, expansion_rate=6, stride=2, activation=activation)
        ) #8

        self.layer3 = torch.nn.Sequential(
            InvertedGhostBottleNeck(in_channels=32, out_channels=32, expansion_rate=6, stride=1, activation=activation),
            InvertedGhostBottleNeck(in_channels=32, out_channels=32, expansion_rate=6, stride=1, activation=activation),
            InvertedGhostBottleNeck(in_channels=32, out_channels=40, expansion_rate=6, stride=2, activation=activation)
        ) #16
        ...
        ##BiSeNet
        self.spatial_path = spatial_path(in_channels=[16, 32, 32])
        ...
        self.feature_fusion_module = FFM(num_classes=self.class_num, in_channels=32 + 40 + 32)
