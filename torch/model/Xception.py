...
class MiddleFlow(torch.nn.Module):
    def __init__(self, activation=torch.nn.ReLU):
        ...
        self.features = torch.nn.Sequential(
            activation(),
            SeparableActivationConv2d(in_channels=728,
                                      out_channels=728,
                                      kernel_size=3,
                                      padding='same',
                                      bias=False,
...
class Xception(torch.nn.Module):
    ...
    def __init__(self, class_num=5, activation=torch.nn.ReLU):
        ...
        self.layer1 = torch.nn.Sequential(
            SeparableActivationConv2d(in_channels=64,
                                      out_channels=128,
                                      kernel_size=3,
                                      stride=1,
                                      padding='same',
            ...
            activation(),
            SeparableActivationConv2d(in_channels=128,
                                      out_channels=128,
                                      kernel_size=3,
                                      stride=1,
                                      padding='same',
        ...
        self.layer2 = torch.nn.Sequential(
            SeparableActivationConv2d(in_channels=128,
                                      ...
                                      activation=activation),
            activation(),
            SeparableActivationConv2d(in_channels=256,
                                      out_channels=256,
                                      kernel_size=3,
                                      stride=1,
                                      padding='same',
        ...
        self.exit_flow1 = torch.nn.Sequential(
            activation(),
            SeparableActivationConv2d(kernel_size=3,
                                      in_channels=728,
                                      out_channels=728,
                                      bias=False,
                                      stride=1,
