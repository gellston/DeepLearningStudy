...
from model.NFResNet import NFResNet152
...
torch.jit.save(compiled_model, "C://Github//DeepLearningStudy//trained_model//FIAT(NFResNet152).pt")
## no Train Model Save
