...
model = CSPSeparableResnet18(class_num=257, activation=torch.nn.SiLU).to(device)
print('==== model info ====')
...
torch.jit.save(trace_model, "C://Github//DeepLearningStudy//trained_model//CALTECH256(CSPSeparableResnet18)_Trace.pt")
