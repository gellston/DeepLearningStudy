...
from model.NFResNet import NFResNet50
...
torch.jit.save(compiled_model, "C://Github//DeepLearningStudy//trained_model//FIAT(NFResNet50).pt")
## no Train Model Save
