...
model = CSPMobileNetV2(class_num=num_class, activation=torch.nn.ReLU6).to(device)
print('==== model info ====')
...
if pretrained == True:
    CSPMobileNetV2Weight = torch.jit.load("C://Github//DeepLearningStudy//trained_model//ImageNet(CSPMobileNetV2).pt")
...
torch.jit.save(trace_model, "C://Github//DeepLearningStudy//trained_model//ImageNet(CSPMobileNetV2)_Trace.pt")
