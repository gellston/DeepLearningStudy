...
class OnyxLineSegmentation:

    def __init__(self, learning_rate=0.003):
        x_input = tf.keras.Input(shape=(192, 1024, 1), name="x_input_node")
        ...
        #uplayer1 = UpSampling2D(size=(2, 2))(center)
