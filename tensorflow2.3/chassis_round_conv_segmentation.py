...
loader_train = opendl_segmentation_dataloader('C://Users//gellston//Desktop//FinalChassisRoundAugmentation//')
loader_test = opendl_segmentation_dataloader('C://Users//gellston//Desktop//FinalChassisRoundAugmentation//')
...
tf.keras.utils.plot_model(model.get_model(), to_file='C:\\Github\\DeepLearningStudy\\trained_model\\ChassisRoundSegmentation.png', show_shapes=True, show_layer_names=True)
...
tf.saved_model.save(model.get_model(), "C:\\Github\\DeepLearningStudy\\trained_model\\ChassisRoundSegmentation")

# Save the weights
model.get_model().save_weights("C:\\Github\\DeepLearningStudy\\trained_model\\ChassisRoundSegmentation.h5")

# Save the model architecture as json
with open("C:\\Github\\DeepLearningStudy\\trained_model\\ChassisRoundSegmentation.json", "w") as fp:
